...
@section('content')
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              ...
              @endif
           <form class="form-horizontal" method="post" action="{{action('DayBookController@store')}}">
            <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input id="date" name="date" type="text" placeholder="date" class="form-control input-md" value="{{ old('date') }}"">
              @if ($errors->has('date'))
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input id="particular" name="particular" type="text" placeholder="Particular" class="form-control input-md" value="{{ old('particular') }}"">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input id="voucher_number" name="voucher_number" type="text" placeholder="Voucher Number" class="form-control input-md" value="{{ old('voucher_number') }}"">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <div class="input-group">
                  ...
                  <input id="debit_amount" name="debit_amount" class="form-control" placeholder="Debit Amount" type="text" value="{{ old('debit_amount') }}"">
                </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input id="create_amount" name="create_amount" type="text" placeholder="Create Amount" class="form-control input-md" value="{{ old('create_amount') }}"">
